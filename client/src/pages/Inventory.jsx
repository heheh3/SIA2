                    ...
                    return(
                        <tr key={item.inventoryID}>
                            ...
                            <div className='quantity-container'>
                              <button className='quantity-btn minus' onClick={() => handleQuantityChange(item.inventoryID, -1)}> - </button>
                              ...
                              <button className='quantity-btn plus'onClick={() => handleQuantityChange(item.inventoryID, 1)}> + </button>
                            </div>
                            </td>
                            <td>
